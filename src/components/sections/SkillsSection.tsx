...
const SkillsSection: React.FC<SkillsSectionProps> = ({ interactiveTextRefs }) => {
  ...
  return (
    <section className="py-12 md:py-20 lg:py-32 px-6 md:px-8" style={{ backgroundColor: theme.colors.surface }}>
      <div className="max-w-7xl mx-auto">
        <motion.h2 className="text-4xl md:text-6xl font-bold mb-8 md:mb-12 lg:mb-16 text-center" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }}>
